...
import org.dspace.app.webui.mpinho.Logbackup;
...
public class EditCommunitiesServlet extends DSpaceServlet
{
            ...
            SQLException, AuthorizeException
    {
        ...
        case CONFIRM_DELETE_COMMUNITY:
            ...
            newLog.updateLogTable(context, community.getID(), Constants.COMMUNITY, community.getHandle(), "delete");
            context.complete();
            //--
        ...
        case CONFIRM_DELETE_COLLECTION:
            ...
            //Commit changes to DB
            context.commit();
            Logbackup newLog2 = new Logbackup();
            newLog2.updateLogTable(context, collection.getID(), Constants.COLLECTION, collection.getHandle(), "delete");
            //Commit changes to DB
            context.complete();
            //--
            ...
            SQLException, AuthorizeException
    {
        ...
        //see if action is create or update
        String action;
        if(request.getParameter("create").equals("true"))
            action = "create";
        else
        ...
        //regist the action in the table logbackup
        Logbackup newLog = new Logbackup();
        newLog.updateLogTable(context, community.getID(), Constants.COMMUNITY, community.getHandle(), action);
            ...
            AuthorizeException
    {
        ...
        else if (button.equals("submit_create_template"))
        {
            ...
            //regist the action in the table logbackup
            Logbackup newLog = new Logbackup();
            newLog.updateLogTable(context, collection.getID(), Constants.COLLECTION, collection.getHandle(), "update");
        ...
        //regist the action in the table logbackup
        Logbackup newLog = new Logbackup();
        newLog.updateLogTable(context, collection.getID(), Constants.COLLECTION, collection.getHandle(), action);
